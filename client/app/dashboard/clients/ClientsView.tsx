...
export default function ClientsView({ initialClients }: ClientsViewProps) {
    ...
    // Note: In a full refactor, we would pass initialClients to useClients context 
    // or use it here as the fallback while loading.
    ...
    // Use initialClients if context is loading and we have data from server
    const clientsToDisplay = (loading && initialClients.length > 0) ? initialClients : displayedClients;
        ...
        <div className="p-4 md:p-8 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden">
                ...
                <div className="md:hidden p-4 space-y-3">
                    {loading && initialClients.length === 0 ? (
                        ...
                        clientsToDisplay.map((client: Client) => (
                            <div
                                key={client.id}
                ...
                <div ref={loadMoreRef} className="h-10 flex items-center justify-center p-4">
                    ...
                    {!hasNextPage && (clientsToDisplay.length > 0) && (
