...
import { DealCreatedEvent } from './events/deals.events';
...
export class DealsService {
  ...
  async getDealsByColumn(
    ...
    // Rule: Filter by agentId if manager/admin, otherwise force my userId
    ...
    // Active Window: Filter Closed deals > 30 days
    if (stageId === 'CERRADO_GANADO' || stageId === 'CERRADO_PERDIDO') {
