...
export class NotificationsService {
    ...
    async createNotification(supabase: SupabaseClient, userId: string, type: string, message: string, link: string = '#') {
        try {
    ...
    async notifyManagers(supabase: SupabaseClient, type: string, message: string, link: string = '#') {
        try {
